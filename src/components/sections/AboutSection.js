                    ...
                    <div className="flex flex-col items-center justify-between md:flex-row">
                        ...
                        <motion.div
                            ...
                            <p className="mb-6 text-lg">
                                ...
                                development, I've honed my skills in creating
                                seamless, user-centric web applications that not
                                only meet but exceed expectations. My journey in
                                tech has been driven by a constant desire to
                                learn and innovate.
                            </p>
                            <p className="mb-6 text-lg">
                                I specialize in building scalable,
                                high-performance applications using cutting-edge
                                technologies. My approach combines creative
                                problem-solving with technical expertise,
                                ensuring that every project I undertake is not
                                just functional, but also innovative and
                                future-proof.
                            </p>
                            <div className="mb-8">
