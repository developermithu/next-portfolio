            ...
            <div className="container px-6 mx-auto">
                ...
                <div className="flex flex-col gap-12 md:flex-row">
                    <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                    >
                        <h3 className="text-2xl font-semibold mb-4 text-[#4fd1c5]">Let's Create Something Amazing</h3>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center">
                                <div className="w-10 h-10 rounded-full bg-[#4fd1c5] flex items-center justify-center mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#1a1f2e]" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                    </svg>
                                </div>
                                <span className="text-white">contact@mithu.dev</span>
                            </div>
                            <div className="flex items-center">
                                <div className="w-10 h-10 rounded-full bg-[#4fd1c5] flex items-center justify-center mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#1a1f2e]" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    >
                        <form className="space-y-4">
                            <div>
                                <label htmlFor="email" className="block mb-1 text-sm font-medium text-gray-400">Email</label>
                                <input
                                    type="email"
                                    id="email"
                                    value={email}
                            ...
                            <div>
                                <label htmlFor="message" className="block mb-1 text-sm font-medium text-gray-400">Message</label>
                                <textarea
                                    id="message"
                                    rows={4}
                                    value={message}
